...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.75\textwidth]{papers/Fusion/figures/cell-pcc-low-high-boxplot-marsilea.pdf}
...
\input{papers/Fusion/tables/gene-table}
\input{papers/Fusion/tables/cell-table}

\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{papers/Fusion/figures/num_uniq_vs_num_genes_in_tiles_log.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\textwidth]{papers/Fusion/figures/min_mae_predictor-scatterplot.png}
...
%\input{papers/Fusion/tables/model-complexity}
% \input{papers/Fusion/tables/cell_type_counts_per_sample}
...
\input{papers/Fusion/tables/cohort}

\begin{figure}[t]
  \centering
  \includegraphics[height=0.8\textheight,keepaspectratio]{papers/Fusion/figures/target-source-correlation-heatmap.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{papers/Fusion/figures/avg_src_corr_vs_performance-scatterplot.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{papers/Fusion/figures/XE_1H49.04_HNE_1H49-04.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{papers/Fusion/figures/appendix/num_tiles_vs_avg_num_cells_per_tile.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{papers/Fusion/figures/appendix/num_uniq_cell_types_vs_num_cells_in_tiles-hue=sample_id.png}
...
%\begin{figure}[t]
%  \centering
%  \includegraphics[height=0.8\textheight]{papers/Fusion/figures/num_transcripts_in_tiles_boxplot.png}
...
\begin{figure}
    \centering
        \includegraphics[height=0.8\textheight]{papers/Fusion/figures/fusion-early-add-mfreeze-0-fusion-sample-level-performance-pearson.pdf}
