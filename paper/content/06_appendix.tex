...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.75\textwidth]{cell-pcc-low-high-boxplot-marsilea.pdf}
...
\input{tables/gene-table}
\input{tables/cell-table}

\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{num_uniq_vs_num_genes_in_tiles_log.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\textwidth]{min_mae_predictor-scatterplot.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[height=0.8\textheight,keepaspectratio]{target-source-correlation-heatmap.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\linewidth]{avg_src_corr_vs_performance-scatterplot.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{XE_1H49.04_HNE_1H49-04.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{appendix/num_tiles_vs_avg_num_cells_per_tile.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{appendix/num_uniq_cell_types_vs_num_cells_in_tiles-hue=sample_id.png}
...
\begin{figure}
    \centering
        \includegraphics[height=0.8\textheight]{fusion-early-add-mfreeze-0-fusion-sample-level-performance-pearson.pdf}
