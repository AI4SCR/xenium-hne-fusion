...
# 1a. save the cell coordinates as Shapely points in geometry instead of .x and .y, going from cells_.parquet to cells.parquet
uv run python scripts/data/save-cell-coords-in-geometry-beat-realign.py
