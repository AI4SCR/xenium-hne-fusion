...
def _run(
    ...
    cfg, metadata_path, eligible_sample_ids = prepare_driver_context(data_cfg)

    retained_sample_ids = eligible_sample_ids
...
def prepare_driver_context(config: DataConfig) -> tuple[PipelineConfig, Path, list[str]]:
